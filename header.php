		...
		<div class="container-fluid m-pad">
			<div class="menu-header">
			   <div class="dsk-logo"><a class="nav-brand" href="index.html">
				  <img src="<?php echo get_template_directory_uri().'/assets/images/white-logo.png'; ?>" alt="Logo" class="mega-white-logo"/>
				  <img src="<?php echo get_template_directory_uri().'/assets/images/logo.png'; ?>" alt="Logo" class="mega-darks-logo"/>
				  </a>
			   </div>
						...
						<div class="contact-inquiry">
						   <div class="contact-info-">
							  ...
							  <div class="inquiry-card-nn hrbg">
								 ...
								 <ul>
									<li class="mb0"><img src="<?php echo get_template_directory_uri().'/assets/images/flags/us.svg'; ?>" alt="us office" class="flags-size"> <a href="tel:1111111111" >+1-123-456-7890</a></li>
								 </ul>
							  </div>
							  <div class="inquiry-card-nn">
								 <div class="title-inq-c">FOR SALES DEPARTMENT</div>
								 <ul>
									<li><a href="tel:1111111111"><img src="<?php echo get_template_directory_uri().'/assets/images/flags/us.svg'; ?>" alt="us office" class="flags-size"> +1-123-456-7890</a></li>
									<li><a href="tel:1111111111"><img src="<?php echo get_template_directory_uri().'/assets/images/flags/au.svg'; ?>" alt="australia office" class="flags-size"> +1-123-456-7890</a></li>
